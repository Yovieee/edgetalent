...
import { CourseSchema, QuizQuestionSchema, ProjectSchema, CourseLessonSchema, FundingOpportunitySchema, EventSchema } from "@edgetalent/shared";
...
export default function AdminDashboard(): React.ReactElement {
  ...
  // Modal / Form States
  const [activeModal, setActiveModal] = useState<"course" | "quiz" | "project" | "lessons" | "funding" | "event" | null>(null);
  ...
  const fetchFundingOpportunities = useCallback(async () => {
    ...
    try {
      ...
      if (!error && data) {
        ...
        showStatus("Failed to load funding opportunities: " + error?.message, "error");
      }
    } catch (e: any) {
  ...
  }, [activeTab, fetchStats, fetchUsers, fetchCourses, fetchProjects, fetchQuizzes, fetchFundingOpportunities, fetchEvents]);
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", position: "relative" }}>
      ...
      >
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: "0.5rem", flex: 1 }}>
          {[
            ...
            { id: "funding", label: "Manage Funding", icon: "💵" },
      ...
      <main style={{ flex: 1, padding: "2.5rem", overflowY: "auto", display: "flex", flexDirection: "column", gap: "2rem" }}>
        ...
        {/* Funding Opportunities Manage Tab */}
        {activeTab === "funding" && (
