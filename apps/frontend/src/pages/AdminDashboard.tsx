...
import { CourseSchema, QuizQuestionSchema, ProjectSchema, CourseLessonSchema, FundingOpportunitySchema } from "@edgetalent/shared";
...
export default function AdminDashboard(): React.ReactElement {
  ...
  // Modal / Form States
  const [activeModal, setActiveModal] = useState<"course" | "quiz" | "project" | "lessons" | "funding" | null>(null);
  ...
  }, [activeTab, fetchStats, fetchUsers, fetchCourses, fetchProjects, fetchQuizzes, fetchFundingOpportunities]);
