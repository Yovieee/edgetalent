      ...
      <aside className={`sidebar ${isSidebarCollapsed ? "collapsed" : ""} ${isMobileOpen ? "open" : ""}`}>
        ...
        <div className="sidebar-menu">
          {[
            ...
            { id: "overview", label: "Manage Projects", icon: <LayoutDashboard size={20} /> },
            { id: "hiring", label: "Hiring Desk", icon: <Users size={20} /> },
            { id: "courses", label: "Entrepreneurship Academy", icon: <GraduationCap size={20} /> },
