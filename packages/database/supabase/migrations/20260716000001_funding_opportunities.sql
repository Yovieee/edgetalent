...
(
  ...
  'YC invests Rp 7.500.000.000 in startup founders twice a year. We help startups build their product, talk to users, raise money, and scale.',
  'Y Combinator is a startup accelerator that launches twice a year. We invest a standard Rp 7.500.000.000 in every startup we accept. The investment is split into two parts: Rp 1.875.000.000 on a post-money safe in exchange for 7% of your company, and Rp 5.625.000.000 on an uncapped safe with a MFN (Most Favored Nation) provision. Beyond funding, YC founders join an elite, lifetime network and get access to top-tier mentorship, resources, and demo day. Startups at any stage, from a mere idea to post-revenue, are welcome to apply.',
  'Rp 7.500.000.000',
...
(
  ...
  'The Google for Startups Accelerator: AI First is designed for startups based in North America and Europe that are leveraging AI/ML technologies. Selected startups receive equity-free support, technical mentorship from Google''s AI experts, Google Cloud credits up to Rp 1.500.000.000, and access to Google''s product teams. The program helps startups solve their technical challenges, optimize their machine learning models, and design go-to-market strategies.',
  'Hingga Rp 1.500.000.000 dalam Kredit Cloud + Support Equity-Free',
...
(
  ...
  'Founded by technology entrepreneur Peter Thiel, the Thiel Fellowship gives Rp 1.500.000.000 to young people who want to build new things instead of sitting in a classroom.',
  'The Thiel Fellowship is a two-year program for young people who want to build new things. Thiel Fellows are given Rp 1.500.000.000 over two years, alongside mentorship and guidance from the Thiel Foundation''s network of founders, investors, and scientists. The only condition is that fellows must drop out of college to pursue their startup full-time. The fellowship is highly competitive and open to applicants under the age of 22.',
...
(
  ...
  'Techstars runs 3-month accelerators in cities worldwide, providing Rp 1.800.000.000 in funding, mentorship, and lifetime access to the Techstars network.',
  'Techstars is a global investment business that provides access to capital, one-on-one mentorship, and customized programming. Every year, Techstars selects more than 500 early-stage companies to join one of its 3-month accelerator programs. Techstars invests Rp 1.800.000.000 in each company: Rp 300.000.000 in exchange for 6% equity, and an optional Rp 1.500.000.000 convertible note. Founders receive hands-on mentorship, access to hundreds of investors, and office space during the program.',
  'Rp 1.800.000.000',
...
(
  ...
  'The National Science Foundation (NSF) Small Business Innovation Research (SBIR) program, also known as America''s Seed Fund, provides up to Rp 30.000.000.000 in equity-free funding for startups developing deep-tech and high-impact technologies. Phase I awards provide up to Rp 4.000.000.000 for feasibility research, while Phase II awards provide up to Rp 15.000.000.000 for prototype development. The funding is non-dilutive, meaning the government takes no equity and no intellectual property rights.',
  'Hingga Rp 30.000.000.000 (Equity-Free)',
